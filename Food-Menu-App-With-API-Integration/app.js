...
main.innerHTML = ` <div class="h-[100px] w-[full]  flex flex-col items-center justify-center">
        ...
        <p class="text-xl font-bold italic"> ${ recipe.publisher}</p>
            </div>

            <!-- image  -->
             <div class="h-[250px]  w-full  flex items-center justify-center p-3">
        ...
        <img src="${recipe.image_url}" alt="" class="h-full w-full rounded-md">
             ...
             <button class="h-[50px] w-[170px]  rounded-md bg-[#59359a] text-white cursor-pointer text-lg">Cook-Time : ${recipe.cooking_time} min</button>
             <button class="h-[50px] w-[170px]  rounded-md bg-[#59359a] text-white cursor-pointer text-lg">Servings : ${recipe.servings} Person</button>
             <button class="h-[50px] w-[170px]  rounded-md bg-[#59359a] text-white cursor-pointer text-lg">Reviews : 6365</button>
             </div>`
